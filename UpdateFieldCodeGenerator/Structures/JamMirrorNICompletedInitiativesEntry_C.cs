...
namespace UpdateFieldCodeGenerator.Structures
{
    public class JamMirrorNICompletedInitiativesEntry_C
    {
        ...
        public static readonly UpdateField m_completedMilestonesSize = new UpdateField(typeof(BlzVectorField<JamMirrorNICompletedMilestoneEntry_C>), UpdateFieldFlag.None, typeof(JamMirrorNICompletedInitiativesEntry_C).GetField("m_completedMilestones", BindingFlags.Static | BindingFlags.Public));
